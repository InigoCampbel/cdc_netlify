...
const DOM = {
  ...
  const SHEET_URL = "https://script.google.com/macros/s/AKfycbwoqQiR-uRLNlCF6-cE8mIiwN4AwNTqGreEaYlq6jbgqzCU6TiSq5_u_IL3vB7NsImzcw/exec";
  
  // Training dates
  const trainingDates = [
      { date: "01-09-2025", day: "Monday" },
      { date: "02-09-2025", day: "Tuesday" },
      { date: "03-09-2025", day: "Wednesday" },
      { date: "04-09-2025", day: "Thursday" },
  ];
  ...
  function setupDateButtons() {
    ...
    trainingDates.forEach((dateInfo, index) => {
      ...
      const displayDate = `${day} September 2025`;
  ...
  const departments = session.departments || "N/A";
  ...
  return `
    ...
    <div class="session-details">
      ...
      <div class="session-detail">
        ...
        <div class="detail-value">${departments}</div>
      </div>
      <div class="session-detail">
